...
2.NumPy (Python Library for numerical and matrix operations)
## Program
```
import numpy as np
pb = [] # Parity matrix
...
## Results
Thus, the Linear Block Code program was successfully executed using a Python compiler. The parity-check matrix was generated, and the errors in the received codeword were detected and corrected.
